...
//
// func (t BodyOneOf) MarshalJSON() ([]byte, error) {
// 	switch t {
// 	case BodyType:
...
// 	case BodyRational:
// 		return []byte(`"Rational"`), nil
// 	case BodyVoid:
// 		return []byte(`"Void"`), nil
// 	}
// 	return nil, fmt.Errorf("failed marshal BodyOneOf '%d': unknown value", t)
// }
// func (t *BodyOneOf) UnmarshalJSON(value []byte) error {
// 	switch string(value) {
// 	case `"Type"`:
// 		*t = BodyType
// 	case `"Struct"`:
...
// 		*t = BodyVoid
// 	default:
// 		return fmt.Errorf("failed unmarshal BodyOneOf from %+v", value)
// 	}
// 	return nil
// }
